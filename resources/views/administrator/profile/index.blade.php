                ...
                <div class="card-body box-profile">
                    <div class="text-center">
                        <label for="uploadFile" data-toggle='tooltip' title='Klik gambar untuk mengupload Foto Profile baru'>
                            <img class="img-fluid img-circle img-100-100" src="{{(!empty($administratorFoto))? asset('admin_profile_pict/'.$administratorFoto) : ''}}" alt="{{$administratorNama}}" onError='this.src="{{asset('img/icon.png')}}"' id='fotoProfile'>
                            <input type="file" id="uploadFile" name='uploadFile' onChange='_imgChanged(this)' data-preview='#fotoProfile' style='display:none;' />
                        </label>
                    </div>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="active tab-pane" id="profile">
                            <h5 class='mb-1'>Form Update Profile</h5>
                            <p class="text-sm text-muted mb-4">Silahkan update profile anda dengan mengisi form di bawah ini</p>
                            <form action="{{route('admin.profile.save')}}" id="formProfile" method="post" onSubmit='_onFormProfilSubmit(this, event)'>
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4">
                                        <label for="uploadFileProfile" data-toggle='tooltip' title='Klik gambar untuk mengupload Foto Profile baru'>
                                            <img class="img-thumbnail w-100" src="{{(!empty($administratorFoto))? asset('admin_profile_pict/'.$administratorFoto) : ''}}"
                                                alt="{{$administratorNama}}" onError='this.src="{{asset('img/icon.png')}}"'
                                                id='foto' />
                                            <input type="file" id="uploadFileProfile" name='uploadFileProfile'
                                                onChange='_imgChanged(this)' data-preview='#foto' style='display:none;' />
                                        </label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <label for="nama">Nama</label>
                                            <input type="text" class="form-control" id="nama" placeholder='Nama Lengkap' name='nama' value='{{$administratorNama}}' required />
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-lg-4">
                                                <label for="telepon">Telepon</label>
                                                <input type="text" class="form-control" id="telepon" placeholder='Nomor Telepon' name='telepon' value='{{$administratorTelepon}}' required />
                                            </div>
                                            <div class="form-group col-lg-8">
                                                <label for="email">Email</label>
                                                <input type="email" class="form-control" id="email" placeholder='Alamat Email' name='email' value='{{$administratorEmail}}' required />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="alamat">Alamat</label>
                                            <textarea name="alamat" id="alamat" placeholder='Alamat Lengkap' class='form-control' required name='alamat'>{{$administratorAlamat}}</textarea>
                                        </div>
                        ...
                        <div class="tab-pane" id="gantiPassword">
                            <h5 class='mb-1'>Form Ganti Password</h5>
                            <p class="text-sm text-muted mb-4">Silahkan ganti password anda dengan mengisi form di bawah ini</p>
                            <form action="{{route('admin.profile.save-ganti-password')}}" id="formGantiPassword" method="post" onSubmit='_onFormGantiPasswordSubmit(this, event)'>
                                ...
                                <div class="form-group" id='passwordSaatIniContainer'>
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control password" id="passwordSaatIni" placeholder='Password Saat Ini' name='passwordSaatIni' required />
                                ...
                                <div class="form-group" id='passwordBaruContainer'>
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control password" id="passwordBaru" placeholder='Password Baru' name='passwordBaru' required />
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group" id='konfirmasiPasswordBaruContainer'>
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control password" id="konfirmasiPasswordBaru" placeholder='Konfirmasi Password Baru' name='konfirmasiPasswordBaru' required />
                                        <div class="input-group-prepend">
