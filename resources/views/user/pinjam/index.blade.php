    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    @if(count($listRiwayatPeminjaman) >= 1)
                    ...
                    @else
                        @include('components.empty', ['title' => 'Peminjaman', 'description' => 'Belum ada riwayat peminjaman'])
                    @endif
                </div>
            </div>
        </div>
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    if(_returnedAt != null){
                        _statusHTML                 =   `<span class='badge badge-info'>Sudah Pengembalian</span>`;
                        _tanggalPengambalianHTML    =   `<p class='text-sm text-muted'>Pengembalian pada <b>${convertDateTime(_returnedAt)}</b></p>`;
                    }
